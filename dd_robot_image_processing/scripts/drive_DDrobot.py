...
class Drive_Robot(object):
    ...
    def set_joint_angles(self, data):
        ...
        self.velocity = self.Kp_v * (self.dist_from_Cube - self.distance) * (-1.0) # try to keep robot a bit away from Bill, so can process him in camera
